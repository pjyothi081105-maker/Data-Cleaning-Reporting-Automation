...
Gender
🚀 How to Run
Open the Python script (data_cleaning.py).
Run the script to generate Cleaned_Sales_Dataset.xlsx.
Open Power BI Desktop.
Import the cleaned dataset.
Create KPI cards, charts, and slicers.
Save the dashboard as Data_Cleaning_Reporting_Automation.pbix.
📋 Business Insights
